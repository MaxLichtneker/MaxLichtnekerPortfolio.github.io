  ...
  return (
    <div className="App">
      ...
      <div className='Description-style'>
        ...
        <ProjectDescription imageName={require('../assets/switch_Project/Switchgameplay.gif')} projectName='SWITCH' projectDescription='A player vs player game I made during internship at Grey Games. I worked as a solo developer using this project learning Unreal engine 4 and Blueprints.' projectYear='2020-2021' projectSoftware='Unreal Engine' projectLength='1 Year'/>
        <ProjectDescription imageName={require('../assets/itchio_Game/Overgrown_Clip.gif')} projectName='OVERGROWN' projectDescription='Overgrown was a game I made at school with a group of 4 I really hope this appears below the image now' projectYear='2020' projectSoftware='Unity' projectLength='3 months'/>
      </div>
      <h1>GAME JAMS</h1>
      <div className='Description-style'>
