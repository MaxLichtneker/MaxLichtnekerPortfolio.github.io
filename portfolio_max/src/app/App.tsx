...
function HomePage(){
    return(
      ...
      <div className='Description-style'>
        <ProjectDescription imageName={require('../assets/a.s.rProject/a.s.r_Burnout_VR.gif')} projectName='A.S.R VR BURNOUT EXPERIENCE' projectLink='/' projectDescription='I made a game for a.s.r I was lead developer, teaching 3 others how to use Unity while building important game systems like the day and night cycle and game manager' projectYear='2025' projectSoftware='Unity' projectLength='6 months'/>
        ...
        <ProjectDescription imageName={require('../assets/itchio_Game/Overgrown_Clip.gif')} projectName='OVERGROWN' projectLink='https://frozen-chicken-nuggies.itch.io/overgrown' projectDescription='For this school project I worked with 3 others to make a game that we would publish on Itch.io. I worked on the plant growth mechanics and collecting mechanics as well as adding animations to the player and the enemy character' projectYear='2020' projectSoftware='Unity' projectLength='3 months'/>
      </div>
      <h1>GAME JAMS</h1>
      <div className='Description-style'>
        ...
        <ProjectDescription imageName={require('../assets/egg_Game_Jam/Egg_Game_Jam_clip.gif')} projectName='SCHOOL GAME JAM THEME EGG' projectLink='/' projectDescription='' projectYear='2025' projectSoftware='Unreal Engine - C++' projectLength='1 week'/>
      </div>
