...
function HomePage(){
    return(
      ...
      <div className='Description-style'>
        <ProjectDescription imageName={require('../assets/a.s.rProject/asr_short.gif')} projectName='A.S.R BURNOUT' projectLink='/asrburnout' projectDescription='My team and I were tasked by a.s.r to make a vr game that would allow people to experience how Burn-out forms and what the effects of it are. I was project lead and Scrum master for this project. I worked on systems like a day and night cycle and the game manager, which would handle all of the different events that could happen in the game.' projectYear='2025' projectSoftware='Unity' projectLength='6 months'/>
        <ProjectDescription imageName={require('../assets/volcano_Fest/Volcano_Fest_Clip (1).gif')} projectName='VOLCANO FEST'  projectLink='/' projectDescription='A multiplayer virtual boardgame, this is currently in development again and will be updated once it is released.' projectYear='2025' projectSoftware='Unity' projectLength='6 months'/>
        ...
        <ProjectDescription imageName={require('../assets/itchio_Game/Overgrown_Clip.gif')} projectName='OVERGROWN' projectLink='/overgrown' projectDescription='For this school project I worked with 3 others to make a game that we published on Itch.io. I programmed the plant growth, collecting mechanics as well as adding animations to the player and the enemy character.' projectYear='2020' projectSoftware='Unity' projectLength='3 months'/>
      </div>
      <h1>GAME JAMS</h1>
      <div className='Description-style'>
        <ProjectDescription imageName={require('../assets/malaga_Jam/FixMyTattoo_Gif_1.gif')} projectName='MALAGA JAM' projectLink='/' projectDescription='Whilst on an educational school trip which only a select few students were chosen for, I participated in the global Game Jam in Malaga Spain. We had 3 days to develop a game with the theme: Repair.' projectYear='2020' projectSoftware='Unity' projectLength='3 days'/>
        <ProjectDescription imageName={require('../assets/egg_Game_Jam/Egg_Game_Jam_clip.gif')} projectName='SCHOOL GAME JAM' projectLink='/gamejamegg' projectDescription='' projectYear='2025' projectSoftware='Unreal Engine - C++' projectLength='1 week'/>
      </div>
